...
fixed_parameters = {
    ...
    "PHASE_2_ACTIVE": "0",
    "PHASE_2_GENE_MOVE_PROB": "0.0",
    "PHASE_2_BIT_INS_PROB": "0.0",
    "PHASE_2_BIT_DEL_PROB": "0.0",
    "PHASE_2_BIT_FLIP_PROB": "0.0",
    "TOURNAMENT_SIZE": "8",
    "LOAD_ANCESTOR": "1",
    "RANDOMIZE_LOAD_ANCESTOR_BITS": "1"
}
...
combos.register_var("GRADIENT_MODEL")
combos.register_var("LOAD_ANCESTOR_FILE")
...
architecture_files = [
    f"architecture-{i}.csv" for i in range(0, 65)
]
combos.add_val(
    "LOAD_ANCESTOR_FILE",
    [
        "${REPO_DIR}/genome-architectures/" + fname
